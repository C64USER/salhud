...
class RegionTableMap extends TableMap
{
     ...
     */
    const COL_POPULATION = 'region.population';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Population', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'population', ),
        self::TYPE_COLNAME       => array(RegionTableMap::COL_ID, RegionTableMap::COL_NAME, RegionTableMap::COL_POPULATION, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'population', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Population' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'population' => 2, ),
        self::TYPE_COLNAME       => array(RegionTableMap::COL_ID => 0, RegionTableMap::COL_NAME => 1, RegionTableMap::COL_POPULATION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'population' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('population', 'Population', 'INTEGER', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Region', '\\Town', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':region_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RegionTableMap::COL_POPULATION);
        } else {
