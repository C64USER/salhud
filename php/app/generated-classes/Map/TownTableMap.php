...
/**
 * This class defines the structure of the 'town' table.
 *
 *
 *
...
class TownTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.TownTableMap';

    /**
     * The default database name for this class
     */
    const DATABASE_NAME = 'salhud';
     ...
     */
    const COL_ID = 'town.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'town.name';

    /**
     * the column name for the mapping field
     */
    const COL_MAPPING = 'town.mapping';

    /**
     * the column name for the region_id field
     */
    const COL_REGION_ID = 'town.region_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Mapping', 'RegionId', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'mapping', 'regionId', ),
        self::TYPE_COLNAME       => array(TownTableMap::COL_ID, TownTableMap::COL_NAME, TownTableMap::COL_MAPPING, TownTableMap::COL_REGION_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'mapping', 'region_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Mapping' => 2, 'RegionId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'mapping' => 2, 'regionId' => 3, ),
        self::TYPE_COLNAME       => array(TownTableMap::COL_ID => 0, TownTableMap::COL_NAME => 1, TownTableMap::COL_MAPPING => 2, TownTableMap::COL_REGION_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'mapping' => 2, 'region_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Town');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 255, null);
        $this->addColumn('mapping', 'Mapping', 'INTEGER', true, null, null);
    ...
    {
        $this->addRelation('Region', '\\Region', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':region_id',
    1 => ':id',
        ...
        $this->addRelation('Town', '\\Case', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':town_id',
    1 => ':id',
  ),
), null, null, 'Towns', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TownTableMap::COL_MAPPING);
            $criteria->addSelectColumn(TownTableMap::COL_REGION_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Town) { // it's a model object
