...
class CaseTableMap extends TableMap
{
     ...
     */
    const COL_YEAR = 'case.year';

    /**
     * the column name for the disease_id field
     */
    const COL_DISEASE_ID = 'case.disease_id';

    /**
     * the column name for the town_id field
     */
    const COL_TOWN_ID = 'case.town_id';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Year', 'DiseaseId', 'TownId', ),
        self::TYPE_CAMELNAME     => array('id', 'year', 'diseaseId', 'townId', ),
        self::TYPE_COLNAME       => array(CaseTableMap::COL_ID, CaseTableMap::COL_YEAR, CaseTableMap::COL_DISEASE_ID, CaseTableMap::COL_TOWN_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'year', 'disease_id', 'town_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Year' => 1, 'DiseaseId' => 2, 'TownId' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'year' => 1, 'diseaseId' => 2, 'townId' => 3, ),
        self::TYPE_COLNAME       => array(CaseTableMap::COL_ID => 0, CaseTableMap::COL_YEAR => 1, CaseTableMap::COL_DISEASE_ID => 2, CaseTableMap::COL_TOWN_ID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'year' => 1, 'disease_id' => 2, 'town_id' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addForeignKey('disease_id', 'DiseaseId', 'INTEGER', 'disease', 'id', true, null, null);
        $this->addForeignKey('town_id', 'TownId', 'INTEGER', 'town', 'id', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Disease', '\\Disease', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':disease_id',
    1 => ':id',
        ...
        $this->addRelation('Town', '\\Town', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':town_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CaseTableMap::COL_YEAR);
            $criteria->addSelectColumn(CaseTableMap::COL_DISEASE_ID);
            $criteria->addSelectColumn(CaseTableMap::COL_TOWN_ID);
        } else {
