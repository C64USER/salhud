...
class DiseaseTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.DiseaseTableMap';
     ...
     */
    const OM_CLASS = '\\Disease';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Disease';
     ...
     */
    const COL_ID = 'disease.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'disease.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(DiseaseTableMap::COL_ID, DiseaseTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(DiseaseTableMap::COL_ID => 0, DiseaseTableMap::COL_NAME => 1, ),
    ...
    {
        $this->addRelation('Disease', '\\Case', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':disease_id',
    1 => ':id',
  ),
), null, null, 'Diseases', false);
    } // buildRelations()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(DiseaseTableMap::COL_ID);
            $criteria->addSelectColumn(DiseaseTableMap::COL_NAME);
        } else {
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(DiseaseTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(DiseaseTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new DiseaseTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Disease) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(DiseaseTableMap::DATABASE_NAME);
            $criteria->add(DiseaseTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(DiseaseTableMap::COL_ID) && $criteria->keyContainsValue(DiseaseTableMap::COL_ID) ) {
