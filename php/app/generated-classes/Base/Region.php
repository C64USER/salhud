...
abstract class Region implements ActiveRecordInterface
{
    ...
    /**
     * @var        ObjectCollection|ChildTown[] Collection to store aggregation of ChildTown objects.
     */
     ...
     * @var ObjectCollection|ChildTown[]
     */
    ...
    public function setPopulation($v)
    {
        ...
        if ($this->population !== $v) {
            $this->population = $v;
            $this->modifiedColumns[RegionTableMap::COL_POPULATION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RegionTableMap::translateFieldName('Population', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_POPULATION)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->collRegions) {
                ...
                $result[$key] = $this->collRegions->toArray(null, false, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RegionTableMap::COL_POPULATION)) {
            $criteria->add(RegionTableMap::COL_POPULATION, $this->population);
        }
    ...
    public function initRegions($overrideExisting = true)
    {
        ...
        $this->collRegions = new ObjectCollection();
        $this->collRegions->setModel('\Town');
    }

    /**
     * Gets an array of ChildTown objects which contain a foreign key that references this object.
     *
     ...
     * @return ObjectCollection|ChildTown[] List of ChildTown objects
     * @throws PropelException
     */
    public function getRegions(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collRegions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collRegions) {
                ...
                $collRegions = ChildTownQuery::create(null, $criteria)
                    ->filterByRegion($this)
                    ->find($con);
    ...
    /**
     * Sets a collection of ChildTown objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param      Collection $regions A Propel collection.
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildRegion The current object (for fluent API support)
     */
    public function setRegions(Collection $regions, ConnectionInterface $con = null)
    {
        /** @var ChildTown[] $regionsToDelete */
    ...
    /**
     * Returns the number of related Town objects.
     *
     * @param      Criteria $criteria
     * @param      boolean $distinct
     * @param      ConnectionInterface $con
     * @return int             Count of related Town objects.
     * @throws PropelException
     */
    public function countRegions(Criteria $criteria = null, $distinct = false, ConnectionInterface $con = null)
    {
        $partial = $this->collRegionsPartial && !$this->isNew();
        if (null === $this->collRegions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collRegions) {
            ...
            $query = ChildTownQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
    ...
    /**
     * Method called to associate a ChildTown object to this object
     * through the ChildTown foreign key attribute.
     *
     * @param  ChildTown $l ChildTown
     * @return $this|\Region The current object (for fluent API support)
     */
    public function addRegion(ChildTown $l)
    {
        if ($this->collRegions === null) {
            $this->initRegions();
            $this->collRegionsPartial = true;
        ...
        if (!$this->collRegions->contains($l)) {
            $this->doAddRegion($l);
        }
    ...
    /**
     * @param ChildTown $region The ChildTown object to add.
     */
    protected function doAddRegion(ChildTown $region)
    {
    ...
    /**
     * @param  ChildTown $region The ChildTown object to remove.
     * @return $this|ChildRegion The current object (for fluent API support)
     */
    public function removeRegion(ChildTown $region)
    {
        if ($this->getRegions()->contains($region)) {
            $pos = $this->collRegions->search($region);
            $this->collRegions->remove($pos);
